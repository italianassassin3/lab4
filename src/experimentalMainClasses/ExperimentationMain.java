...
import sorterClasses.OddEvenSortSorter;
...
public class ExperimentationMain {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		ec.addStrategy(new StrategiesTimeCollection<Integer>(new CombSortSorter<Integer>()));//Correctly implemented for lab activity
		ec.addStrategy(new StrategiesTimeCollection<Integer>(new CocktailSortSorter<Integer>()));//Correctly implemented for lab activity

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		//ec.addStrategy(new StrategiesTimeCollection<Integer>(new OddEvenSortSorter<Integer>())); //NOT WORKING, implemented for fun in the lab activity
		//ec.addStrategy(new StrategiesTimeCollection<Integer>(new GNomeSortSorter<Integer>())); //NOT WORKING, implemented for fun in the lab activity
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
